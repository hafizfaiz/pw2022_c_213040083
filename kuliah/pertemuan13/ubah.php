        ...
        <div class="row mt-3">
          ...
          <div class="col-8">
            ...
            <div class="mb-3">
                ...
                <input type="number" name="npm" class="form-control" id="npm" required style="width: 250px;" value="<?= $mhs["npm"]?>">
              </div>
            <div class="mb-3">
                <label for="email" class="form-label">Email :</label>
                <input type="email" name="email" class="form-control" id="email" required value="<?= $mhs["email"]?>">
              </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="gambar" class="form-control" id="gambar" required value="<?= $mhs["gambar"]?>">
              </div>
