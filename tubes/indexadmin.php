            ...
            <div class="col">
                <div class="card bg-dark text-white">
                  ...
                  <div class="card-img-overlay d-flex align-items-end justify-content-start">
                    <a type="button" class="btn" style=" background-color:rgb(0, 141, 201); color:white" href="newspageadmin.php?id=<?= $brt["id"]; ?>">Selengkapnya</a>
   ...
   <div class="card text-dark bg-info">
       <div class="card-covid mt-3 mx-3 mb-3">
           <div style="color:white">
            ...
            <a type="button" class="btn" style=" background-color:rgb(0, 141, 201); color:white" href="petasebaran2.php">Selengkapnya</a>
          </div>
      </div>
    </div>
  </div>
      ...
      <div class="row">
        ...
        <div class="card mt-3 mx-3 border-0 my-5" style="width: 20rem;">
          ...
          <div class="card-body">
            ...
            <a href="keluhanadmin.php" class="btn btn-primary">selengkapnya</a>
          </div>
        </div>
        </div>
        <div class="col">
        <div class="card mt-3 mx-3 border-0 my-5" style="width: 20rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">detail mengenai obat-obatan.</p>
            <a href="obatadmin.php" class="btn btn-primary">selengkapnya</a>
          </div>
        </div>
        </div>
        <div class="col">
        <div class="card mt-3 mx-3 border-0 my-5" style="width: 20rem;">
          ...
          <div class="card-body">
            ...
            <p class="card-text">Informasi mengenai penyakit-penyakit.</p>
            <a href="penyakit2.php" class="btn btn-primary">selengkapnya</a>
          </div>
        </div>
        </div>
    </div>
